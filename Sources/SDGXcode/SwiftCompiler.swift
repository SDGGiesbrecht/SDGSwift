...
extension SwiftCompiler {
    ...
    @discardableResult public static func generateXcodeProject(for package: PackageRepository, reportProgress: (String) -> Void = SwiftCompiler._ignoreProgress) throws -> String {
