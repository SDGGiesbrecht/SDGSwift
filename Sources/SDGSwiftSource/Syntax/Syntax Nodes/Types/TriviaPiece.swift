...
extension TriviaPiece {
  ...
  public var isNewline: Bool {
    switch self {
    case .spaces, .tabs, .backticks, .lineComment, .blockComment, .docLineComment, .docBlockComment,
      .garbageText:
      return false
  ...
  private func upperBound(from lowerBound: String.ScalarView.Index, in context: TriviaPieceContext)
