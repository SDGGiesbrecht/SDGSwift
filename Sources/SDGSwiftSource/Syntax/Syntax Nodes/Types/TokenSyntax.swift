...
extension TokenSyntax {
    ...
    internal func syntaxHighlightingClass(internalIdentifiers: Set<String>) -> String? {
        ...
        case .arrow, .colon, .semicolon, .comma, .period, .equal, .prefixPeriod, .leftParen, .rightParen, .leftBrace, .rightBrace, .leftSquareBracket, .rightSquareBracket, .leftAngle, .rightAngle, .prefixAmpersand, .postfixQuestionMark, .infixQuestionMark, .exclamationMark, .backslash, .stringInterpolationAnchor, .dollarIdentifier, .backtick:
            return "punctuation"
