...
extension TokenSyntax {
  ...
  public var textFreedom: TextFreedom {
    ...
    case .eof, .associatedtypeKeyword, .classKeyword, .deinitKeyword, .enumKeyword,
      ...
      .poundFunctionKeyword, .poundSelectorKeyword, .poundKeyPathKeyword, .poundColorLiteralKeyword,
      ...
      .stringInterpolationAnchor, .stringQuote, .multilineStringQuote, .dollarIdentifier,
      .contextualKeyword, .unknown, .pound, .backtick, .poundAssertKeyword, .poundWarningKeyword,
  ...
  internal func syntaxHighlightingClass(internalIdentifiers: Set<String>) -> String? {
    ...
    case .associatedtypeKeyword, .classKeyword, .deinitKeyword, .enumKeyword, .extensionKeyword,
      ...
      .throwKeyword, .trueKeyword, .tryKeyword, .throwsKeyword, .__file__Keyword, .__line__Keyword,
      .__column__Keyword, .__function__Keyword, .__dso_handle__Keyword, .wildcardKeyword,
      .poundAvailableKeyword, .poundSourceLocationKeyword, .poundFileKeyword, .poundLineKeyword,
      .poundColumnKeyword, .poundDsohandleKeyword, .poundFunctionKeyword, .poundSelectorKeyword,
      .poundKeyPathKeyword, .poundColorLiteralKeyword, .poundFileLiteralKeyword,
      .poundImageLiteralKeyword, .atSign, .contextualKeyword, .poundAssertKeyword, .yield:
      return "keyword"
    ...
    case .identifier(let name), .unspacedBinaryOperator(let name), .spacedBinaryOperator(let name),
