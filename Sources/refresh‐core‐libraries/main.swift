...
do {
  ...
  let branchName =
    "swift\u{2D}\(SwiftCompiler._standardLibraryVersion.string(droppingEmptyPatch: true))\u{2D}RELEASE"
  ...
  moduleEnumeration: for (name, module) in modules.sorted(by: { $0.0 < $1.0 }) {
    ...
    try FileManager.default.withTemporaryDirectory(appropriateFor: URL(fileURLWithPath: #file)) {
