...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/SDGGiesbrecht/swift\u{2D}package\u{2D}manager", .branch("swift‐5.1")),
        .package(url: "https://github.com/apple/swift\u{2D}syntax", .revision("xcode11-beta1")),
