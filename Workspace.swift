...
configuration.documentation.currentVersion = Version(0, 4, 4)
...
// #workaround(workspace version 0.16.0, Inline SwiftLint statements can be removed when SwiftLint is deprecated.)
