...
configuration.documentation.currentVersion = Version(0, 4, 6)
...
// #workaround(workspace version 0.17.0, Currently inaccurate.)
configuration.proofreading.rules.remove(.calloutCasing)

// #workaround(workspace version 0.17.0, Inline SwiftLint statements can be removed when SwiftLint is deprecated.)
