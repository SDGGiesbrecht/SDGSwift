...
class APITests : TestCase {
    ...
    func testGitError() {
        testCustomStringConvertibleConformance(of: VersionedExternalProcessExecutionError<Git>.locationError(.unavailable), localizations: InterfaceLocalization.self, uniqueTestName: "Git Unavailable", overwriteSpecificationInsteadOfFailing: false)
    ...
    func testSwiftCompilerError() {
        ...
        testCustomStringConvertibleConformance(of: VersionedExternalProcessExecutionError<SwiftCompiler>.locationError(.unavailable), localizations: InterfaceLocalization.self, uniqueTestName: "Swift Unavailable", overwriteSpecificationInsteadOfFailing: false)
